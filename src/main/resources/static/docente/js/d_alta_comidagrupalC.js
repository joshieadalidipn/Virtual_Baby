...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const createInfanteRow = (infante) => {
        ...
        row.appendChild(document.createElement("td")).appendChild(createMenu(infante.id));
        row.appendChild(document.createElement("td")).appendChild(createQuantity(infante.id));
